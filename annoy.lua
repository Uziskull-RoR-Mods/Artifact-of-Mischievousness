...
artifact.loadoutSprite = Sprite.load("evil_artifacts_artifact", "sprites/annoyArtifact", 2, 18, 18)
artifact.loadoutText = "Hey, don't click me!"
--artifact.pickupSprite = Sprite.load("artifact_evil_artifacts_pickup", "sprites/annoyArtifact_object", 1, 32, 32)
...
local beCalm = Sound.load("evil_artifacts_sound_be_calm", "sound/bigEnough/calm")
local beBuildup = Sound.load("evil_artifacts_sound_be_buildup", "sound/bigEnough/buildup")
local beAaaaa = Sound.load("evil_artifacts_sound_be_aaaaa", "sound/bigEnough/aaaaa")
local beSprite1 = Sprite.load("evil_artifacts_sound_be_sprite1", "sprites/bigEnough/1", 51, 0, 0)
local beSprite2 = Sprite.load("evil_artifacts_sound_be_sprite2", "sprites/bigEnough/2", 51, 0, 0)
local beSprite3 = Sprite.load("evil_artifacts_sound_be_sprite3", "sprites/bigEnough/3", 51, 0, 0)
local beSprite4 = Sprite.load("evil_artifacts_sound_be_sprite4", "sprites/bigEnough/4", 51, 0, 0)
local beSprite5 = Sprite.load("evil_artifacts_sound_be_sprite5", "sprites/bigEnough/5", 51, 0, 0)
local beSprite6 = Sprite.load("evil_artifacts_sound_be_sprite6", "sprites/bigEnough/6", 51, 0, 0)
...
local catSprite1 = Sprite.load("evil_artifacts_cat_sprite1", "sprites/cat/cat1", 1, 274, 0)
local catSprite2 = Sprite.load("evil_artifacts_cat_sprite2", "sprites/cat/cat2", 1, 0, 0)
...
registercallback("onStageEntry", function()
    ...
    if interestingThingToDo == 2 then
        catFont = {
            small = graphics.fontFromFile("sprites/cat/comicbd", 24),
            medium = graphics.fontFromFile("sprites/cat/comicbd", 36),
            large = graphics.fontFromFile("sprites/cat/comicbd", 72)
        }
